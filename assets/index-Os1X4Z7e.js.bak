...
const Xm_StandaloneContractPortal = ({ contractId }) => {
  ...
  // CỔNG BẮT BUỘC ĐĂNG NHẬP GMAIL TRƯỚC KHI VÀO XEM HỢP ĐỒNG
  if (!customerUser) {
    return c.jsxs("div", {
